    ...
    >
        <div class="border-b border-border/80 pb-3">
            ...
            <p class="text-xs text-fg-muted">
                {{
                    isDistrictAdmin
                        ? "Persentase komoditas di setiap kampung."
        ...
        <div class="mt-4 space-y-4 flex-1">
            <div
                v-if="regionDistribution.length === 0"
                class="text-xs text-center text-fg-muted italic py-4"
            >
            ...
            >
                <div class="flex justify-between gap-3 text-xs font-semibold">
                    ...
                    <span class="shrink-0 font-bold tabular-nums text-brand"
        ...
        >
            ...
            <p class="mt-1 text-[11px]">
                Seluruh perubahan data dikelola secara jujur dan berstandar
                institusi.
            </p>
        </div>
    </div>
