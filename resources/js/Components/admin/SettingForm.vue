    ...
    <div>
        ...
        <form v-else @submit.prevent="handleSave" class="space-y-6 pb-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div
                    class="rounded-2xl border border-border/80 bg-white p-6 shadow-xs space-y-5 h-full"
                >
                    <div
                    ...
                    >
                        ...
                        <h3 class="text-sm font-bold text-fg">
                            Narasi Halaman Tentang
                        </h3>
                    </div>

                    <p class="text-xs text-fg-muted pb-2">
                        Teks yang akan ditampilkan pada halaman Tentang Kami di
                        sisi publik.
                    </p>
                    ...
                    <div class="space-y-4">
                        <Field
                            ...
                            :error="errors.about_background?.[0]"
                        >
                            <div
                                class="border rounded-md border-border/80 overflow-hidden"
                                :class="{
                                    'border-danger': !!errors.about_background,
                                }"
                            >
                                <QuillEditor
                                    theme="snow"
                        ...
                        <Field
                            ...
                            :error="errors.about_purpose?.[0]"
                        >
                            <div
                                class="border rounded-md border-border/80 overflow-hidden"
                                :class="{
                                    'border-danger': !!errors.about_purpose,
                                }"
                            >
                                <QuillEditor
                                    theme="snow"
                ...
                >
                    ...
                    <p class="text-xs text-fg-muted pb-2">
                        Informasi yang ditampilkan agar pengguna dapat
                        menghubungi pengelola.
                    </p>

                    <div class="space-y-4">
                        <Field
                            label="Nama Kontak (Admin)"
                            :error="errors.admin_contact_name?.[0]"
                        >
                            <Input
                        ...
                        <Field
                            ...
                            :error="errors.admin_contact_phone?.[0]"
                        >
                            <PhoneInput
                        ...
                        <Field
                            label="Alamat Email"
                            :error="errors.admin_contact_email?.[0]"
                        >
                            <Input
                    ...
                    <div
                        class="mt-6 p-4 rounded-xl bg-blue-50/50 border border-blue-100 flex gap-3 text-blue-700"
                    >
                        <Icon
                            :icon="Info"
                            :size="20"
                        ...
                        <p class="text-xs leading-relaxed">
                            <strong>Penting:</strong> Data kontak di atas sangat
                            krusial karena merupakan ujung tombak komunikasi
                            antara pengunjung publik dengan pengelola program
                            DigiPangan Merauke.
                        </p>
                    </div>
                </div>
