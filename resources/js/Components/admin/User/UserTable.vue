                ...
                >
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-3">
                            <div
                                class="size-9 rounded-full bg-brand/10 flex items-center justify-center shrink-0 overflow-hidden"
                            >
                                <img
                    ...
                    <td class="px-4 py-4">
                        <div class="flex flex-wrap items-center gap-1.5">
                            ...
                            >
                                ...
                                <span
                                    v-if="
                                        role === 'admin_distrik' && item.region
                                    "
                                    >Admin {{ item.region.name }}</span
                                >
                                <span v-else>{{
                                    roleLabel[role] ?? role
                                }}</span>
