...
export interface FarmerProductFormData {
    id?: number | string;
    name?: string;
...
const props = defineProps<{
    initialData?: FarmerProductFormData;
    isEdit?: boolean;
...
type ToggleKey = "stock_available" | "is_active";
    ...
    try {
        ...
        const endpoint =
            props.isEdit && props.initialData?.id
                ? `/petani/dashboard/produk/${props.initialData.id}`
                : "/petani/dashboard/produk";
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p class="text-xs text-fg-muted">
                                Pengaturan stok &amp; tampilan di etalase publik
                            </p>
                        </div>
                    </div>
