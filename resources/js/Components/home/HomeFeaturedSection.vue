...
<template>
  <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
    <div class="flex flex-col justify-between gap-6 md:flex-row md:items-end">
      <div class="space-y-3">
        ...
        <p class="text-base text-fg-muted">
          Pilihan hasil panen terbaik langsung dari lahan transmigran di Kabupaten Merauke.
        </p>
      </div>
    ...
    >
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-6 lg:grid-cols-2">
        <ProductCard
