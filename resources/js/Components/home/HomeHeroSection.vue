...
<template>
    <section
        class="relative isolate -mt-16 overflow-hidden pt-16 md:-mt-20 lg:min-h-[95vh] lg:pt-20"
    >
        <div
        ...
        >
            <div class="space-y-8 lg:col-span-7">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    >
                        <span
                            class="flex size-5 items-center justify-center rounded-full bg-brand text-on-brand"
                        >
                ...
                <p
                    class="max-w-2xl text-base leading-relaxed text-fg-muted sm:text-lg"
                >
                    Platform marketplace komunitas resmi etalase komoditas
                    unggulan kawasan transmigrasi
                    <strong class="text-fg">Muting, Ulilin, dan Elikobel</strong
                    >. Hubungi petani dan koperasi secara langsung, tanpa rantai
                    perantara.
                </p>
                ...
                <div class="pt-2">
                    <p
                        class="mb-2.5 text-xs font-bold uppercase tracking-wider text-fg-muted/80"
                    >
            ...
            <div class="relative lg:col-span-5 lg:pl-4">
                <component
                    ...
                    :href="
                        heroProduct ? `/produk/${heroProduct.slug}` : undefined
                    "
                            ...
                            >
                                <div class="min-w-0">
                                    ...
                                    >
                                        ...
                                        Distrik {{ heroProduct.region.name }}
                                    </p>
                                    <p
                                ...
                                <span
                                    class="shrink-0 text-xl font-bold tabular-nums text-brand"
                                >
                                    {{
        ...
        <div class="border-y border-border/80 bg-white py-10 shadow-soft">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div
                    class="grid grid-cols-1 divide-y divide-border/80 md:grid-cols-2 md:divide-y-0 lg:grid-cols-4 lg:divide-x"
                >
                    <div
                    ...
                    >
                        <p
                            class="text-[11px] font-mono font-bold uppercase tracking-widest text-fg-muted/60"
                        >
                            0{{ idx + 1 }} /
                            {{
                                idx === 0
                        ...
                        <p
                            class="mt-2 text-3xl font-extrabold tabular-nums text-fg lg:text-4xl"
                        >
                            {{ st.value }}
