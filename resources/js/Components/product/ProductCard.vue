...
const card = tv({
    slots: {
        frame: "group flex h-full flex-col overflow-hidden rounded-card border border-border/80 bg-white shadow-xs transition-[transform,box-shadow] duration-300 ease-out hover:-translate-y-1 hover:shadow-soft",
    ...
    variants: {
        variant: {
            ...
            spotlight: {
                media: "aspect-[16/9] sm:aspect-square",
                body: "gap-1.5 p-4 sm:p-5",
                title: "text-lg sm:text-xl",
                price: "text-xl sm:text-2xl",
                footer: "mt-auto pt-3",
            },
            horizontal: {
                frame: "flex-col sm:flex-row",
                media: "w-full sm:w-[40%] shrink-0 aspect-[16/9] sm:aspect-auto",
                body: "justify-center gap-1 p-4 sm:p-5",
