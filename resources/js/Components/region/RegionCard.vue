...
const props = withDefaults(
    defineProps<{ region: RegionCard; layout?: "horizontal" | "vertical" }>(),
    {
        layout: "horizontal",
    },
);
        ...
        >
            ...
            >
                <div>
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <span
                            :class="[
                                ...
                                layout === 'horizontal'
                                    ? 'sm:opacity-0 group-hover:opacity-100 sm:-translate-x-2 group-hover:translate-x-0'
                                    : '',
                            ]"
                            aria-hidden="true"
                        >
                    ...
                    <p
                        class="text-sm text-fg-muted mt-2 line-clamp-2"
                        :class="layout === 'horizontal' ? 'max-w-lg' : ''"
                    >
                        Eksplorasi potensi pertanian, kelompok tani aktif, dan
                        komoditas unggulan di distrik transmigrasi
                        {{ region.name }}.
                    </p>
                </div>
                ...
                <div
                    :class="[
                        'border-border/60',
                        layout === 'horizontal'
                            ? 'mt-6 sm:mt-8 pt-6 sm:pt-0 border-t sm:border-0'
                            : 'mt-6 pt-6 border-t',
                    ]"
                >
