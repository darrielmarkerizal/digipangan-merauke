...
<template>
    <nav aria-label="Breadcrumb" class="flex min-w-0 items-center text-sm">
        <ol
            ...
            class="flex min-w-0 flex-wrap items-center gap-1.5 sm:gap-2"
        >
            <li
            ...
            >
                ...
                >
                    ...
                    <span
                        class="max-w-[8rem] truncate sm:max-w-[16rem] lg:max-w-none"
                        >{{ item.label }}</span
                    >
                </Link>
                ...
                >
                    <Icon v-if="item.icon" :icon="item.icon" :size="15" />
                    <span
                        class="max-w-[10rem] truncate sm:max-w-[20rem] lg:max-w-none"
                        >{{ item.label }}</span
                    >
                </span>
            </li>
