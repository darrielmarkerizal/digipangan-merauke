            ...
            return () =>
                h(Accordion, null, {
                    default: () => [
                        h(
                            AccordionItem,
                            { value: "a", title: "Apa itu DigiPangan?" },
                            { default: () => "Etalase komoditas lokal." },
                        ),
                        h(
                            AccordionItem,
                            {
                                value: "b",
                                title: "Bagaimana menghubungi petani?",
                            },
                            { default: () => "Lewat tombol WhatsApp." },
                        ),
                    ],
                });
        },
