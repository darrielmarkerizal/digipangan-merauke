...
<template>
    ...
    >
        ...
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-12">
            <div
                class="rounded-xl border border-border/80 bg-white p-5 shadow-xs lg:col-span-8"
            >
                <div
                ...
                >
                    ...
                    <span
                        class="rounded-full bg-brand-weak px-2.5 py-1 text-[11px] font-bold text-brand"
                    >
                        Live Metric
                    </span>
                </div>
                ...
                <div
                    class="mt-4 flex h-52 flex-col items-center justify-center rounded-xl border border-dashed border-border/80 bg-muted/20 text-center p-4"
                >
                    <Icon :icon="TrendingUp" :size="36" class="text-brand/40" />
                    <p class="mt-2.5 text-xs font-semibold text-fg">
                        Modul Visualisasi ApexCharts siap dihubungkan
                    </p>
                    <p class="mt-1 text-[11px] text-fg-muted max-w-sm">
                        Data interaksi pembeli dengan petani dipetakan ke dalam
                        grafik deret waktu harian &amp; bulanan.
                    </p>
                </div>
            </div>

            <div
                class="rounded-xl border border-border/80 bg-white p-5 shadow-xs lg:col-span-4"
            >
                <div class="border-b border-border/80 pb-3">
                    ...
                    <p class="text-xs text-fg-muted">
                        Persentase komoditas di 3 kawasan utama.
                    </p>
                </div>
                ...
                <div class="mt-4 space-y-4">
                    <div class="space-y-1.5">
                        <div class="flex justify-between text-xs font-semibold">
                            <span class="text-fg">Distrik Muting</span>
                            <span class="font-bold tabular-nums text-brand"
                                >42%</span
                            >
                        </div>
                        <div
                    ...
                    <div class="space-y-1.5">
                        <div class="flex justify-between text-xs font-semibold">
                            <span class="text-fg">Distrik Elikobel</span>
                            <span class="font-bold tabular-nums text-brand"
                                >20%</span
                            >
                        </div>
                ...
                <div
                    class="mt-5 rounded-xl border border-brand/20 bg-brand-weak/60 p-3.5 text-xs text-fg-muted"
                >
