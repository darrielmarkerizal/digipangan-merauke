...
const executeDelete = (id: number) => {
    router.delete(`/admin/petani/${id}`, {
        ...
        onError: () => {
            toast.error(
                "Gagal menghapus data petani (kemungkinan terkait dengan produk panen).",
            );
        },
    });
};
...
<template>
    ...
    >
        ...
        <div class="space-y-4">
                            ...
                            >
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="size-10 shrink-0 overflow-hidden rounded-full bg-brand-weak/30 border border-brand/20 flex items-center justify-center font-bold text-brand text-sm"
                                        >
                                            <img
                                                v-if="
                                                    item.photo?.thumb ||
                                        ...
                                        <div>
                                            <Link
                                                ...
                                                class="font-bold text-fg hover:text-brand transition-colors"
                                            >
                                                {{ item.name }}
                                            </Link>
                                            <div
                                ...
                                <td
                                    class="px-4 py-4 text-xs text-fg font-medium"
                                >
            ...
            <Pagination :links="farmers?.links" :meta="farmers?.meta" />
        </div>
    </AdminLayout>
</template>
