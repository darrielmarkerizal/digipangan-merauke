...
const executeDelete = (id: number) => {
    router.delete(`/admin/satuan/${id}`, {
        ...
        onError: () => {
            toast.error(
                "Gagal menghapus satuan (kemungkinan masih digunakan oleh produk).",
            );
        },
    });
};
                    ...
                    <table class="w-full text-left text-sm text-fg">
                        ...
                        <tbody class="divide-y divide-border/60">
                            ...
                            >
                                ...
                                <td class="px-4 py-4">
                                    <span
                                        class="inline-flex items-center justify-center px-2.5 py-0.5 rounded-md bg-muted text-xs font-semibold font-mono text-fg"
                                    >
                                        {{ item.symbol }}
                                    </span>
                                </td>
