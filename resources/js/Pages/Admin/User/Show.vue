        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    >
                        <div
                            class="flex items-center gap-4 pb-6 border-b border-border/60"
                        >
                            <div
                                class="size-16 rounded-full bg-brand/10 flex items-center justify-center shrink-0 overflow-hidden border border-brand/20"
                            >
                                <img
                            ...
                            <div class="min-w-0">
                                <h2
                                    class="break-words text-xl font-bold text-fg"
                                >
                                    {{ user.name }}
                                </h2>
                                <p
                                    class="mt-1 flex items-center gap-1.5 break-all text-sm text-fg-muted sm:break-normal"
                                >
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                <span
                                    class="text-xs font-semibold text-fg-muted uppercase tracking-wider block mb-1"
                                    >Nama Lengkap</span
                                >
                                <p
                                    class="text-sm font-semibold text-fg flex items-center gap-2"
                                >
                                    <Icon
                                        :icon="UserIcon"
                                        :size="15"
                        ...
                        <div
                            class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-border/60"
                        >
                            <div>
                                <span
                                    class="text-xs font-semibold text-fg-muted uppercase tracking-wider block mb-1"
                ...
                <div class="space-y-6">
                    ...
                    >
                        <h3
                            class="text-sm font-bold text-fg border-b border-border/60 pb-3 flex items-center gap-2"
                        >
                            <Icon
                                :icon="Shield"
                                :size="16"
                        ...
                        <div>
                            <span
                                class="text-xs font-semibold text-fg-muted block mb-2"
                                >Status Akun</span
                            >
                            <Badge
                                :variant="
                                ...
                                "
                                class="gap-1 px-3 py-1 text-xs"
                            >
                                <Icon
                                    :icon="
                                        user.is_active ? CheckCircle2 : XCircle
                                    "
                                    :size="14"
                                />
                                {{
