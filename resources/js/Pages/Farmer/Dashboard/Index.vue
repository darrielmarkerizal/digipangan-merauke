    ...
    >
        ...
        <div class="space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                    <span
                        class="flex size-11 items-center justify-center rounded-xl bg-brand-weak text-brand shrink-0"
                    >
                        <Icon :icon="card.icon" :size="20" />
                    </span>
                    <div>
                        <p class="text-2xl font-extrabold text-fg">
                            {{ metrics?.[card.key] ?? 0 }}
                        </p>
            ...
            >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <p
                            class="font-semibold text-fg flex items-center gap-1.5"
                        >
                ...
                <Link
                    ...
                    class="inline-block text-xs font-semibold text-brand hover:text-brand-strong"
                >
            ...
            <div class="rounded-2xl border border-border/80 bg-white shadow-xs">
                <div
                    class="flex flex-wrap items-center justify-between gap-2 border-b border-border/60 p-5"
                >
                    <h3 class="text-sm font-bold text-fg">Produk Terbaru</h3>
                    <Link
                        href="/petani/dashboard/produk"
                        class="text-xs font-semibold text-brand hover:text-brand-strong"
                    >
                        Lihat Semua
                    </Link>
                </div>
                ...
                <div v-else class="divide-y divide-border/60">
                    ...
                    >
                        <div class="min-w-0">
                            <p class="break-words text-sm font-bold text-fg">
                                {{ product.name }}
                            </p>
                        ...
                        >
                            ...
                            <Badge
                                :variant="
                                    product.stock_available ? 'brand' : 'danger'
                                "
                            >
                                {{
