...
import { Plus, Search, Edit2, Trash2, ShoppingBasket } from "@lucide/vue";
import {
    Icon,
    Badge,
    Button,
                            ...
                            >
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="size-10 shrink-0 overflow-hidden rounded-lg bg-muted/40"
                                        >
                                            <img
                                                v-if="item.image_url"
                                                :src="item.image_url"
                                ...
                                <td class="px-5 py-4 text-right">
                                    ...
                                    >
                                        <Link
                                            :href="`/petani/dashboard/produk/${item.id}/edit`"
                                        >
                                            <Button
                                                variant="secondary"
                                                size="sm"
