    ...
    <main class="mx-auto max-w-4xl space-y-12 px-4 py-10">
        ...
        <section class="space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <Button variant="whatsapp"
                    ><Icon :icon="Phone" :size="18" /> WhatsApp</Button
                >
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <Button icon-only aria-label="Cari"
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <Card interactive :padding="'none'">
                    ...
                    <div class="space-y-1 p-4">
                        ...
                        <p class="pt-1 text-lg font-bold tabular-nums text-fg">
                            Rp 45.000
                        </p>
                    </div>
                </Card>
                <Card :padding="'none'">
                    <Skeleton
                        radius="none"
                        class="aspect-[4/3] rounded-t-card"
                    />
        ...
        <section class="space-y-4">
            ...
            <Accordion default-value="a">
                ...
                <AccordionItem
                    value="b"
                    title="Bagaimana cara menghubungi petani?"
                >
